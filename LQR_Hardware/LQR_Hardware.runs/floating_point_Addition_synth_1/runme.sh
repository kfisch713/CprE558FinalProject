...
HD_PWD='C:/Users/Matthew/Desktop/LQR_Vivado/LQR_Hardware/LQR_Hardware.runs/floating_point_Addition_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floating_point_Addition.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source floating_point_Addition.tcl
