...
HD_PWD='C:/Users/Matthew/Desktop/LQR_Vivado/LQR_Hardware/LQR_Hardware.runs/floating_point_Float32_to_Int32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floating_point_Float32_to_Int32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source floating_point_Float32_to_Int32.tcl
