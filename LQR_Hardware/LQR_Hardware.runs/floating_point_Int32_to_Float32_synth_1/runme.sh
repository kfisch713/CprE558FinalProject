...
HD_PWD='/home/ericm/Documents/Classes/cpre583/final_project/LQR_Hardware/LQR_Hardware.runs/floating_point_Int32_to_Float32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floating_point_Int32_to_Float32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source floating_point_Int32_to_Float32.tcl
